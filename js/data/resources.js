...
export const RESOURCES = {
  ...
  ancient_wood: {
    ...
    tier: 3,
    icon: "🌳",
    image: "assets/resources/ancient_wood.png",
    source: "Bûcheronnage (haut niveau)",
    desc: "Un bois sombre et noueux, gorgé d'âge. Idéal pour les armes magiques et les arcs longs.",
  },
  coal: {
    id: "coal",
    name: "Charbon",
    tier: 2,
    icon: "🪨",
    image: "assets/resources/coal.png",
    source: "Minage",
    desc: "Brûle longtemps et fort : fondant pour la fonte et trempe pour la forge.",
  },
  silver_ore: {
    id: "silver_ore",
    ...
    tier: 3,
    icon: "🔘",
    image: "assets/resources/silver_ore.png",
    source: "Minage (haut niveau)",
    desc: "Un minerai pâle et précieux, à fondre avec du charbon.",
  },
  silver_ingot: {
    id: "silver_ingot",
    ...
    tier: 4,
    icon: "🧱",
    image: "assets/resources/silver_ingot.png",
    source: "Fonte",
    desc: "De l'argent raffiné, parfait pour la joaillerie et les pièces fines.",
  },
  copper_ingot: {
    id: "copper_ingot",
