...
export const SPECIALIZATIONS = {
  ...
  guardian_bulwark: {
    ...
    desc: "Défense et régénération extrêmes. Rien ne passe.",
    statMods: { defPct: 0.18, hpPct: 0.1 },
    passive: { hpRegenPct: 0.04 },
    grants: ["fortress"],
    mastery: { wtype: "shield", defPct: 0.12 },
  },
  guardian_templar: {
    id: "guardian_templar", classId: "guardian", name: "Templier", tagline: "La foi qui soigne et punit.",
    desc: "Convertit ses dégâts en soins. Un tank qui rend coup pour coup.",
    statMods: { atkPct: 0.1, defPct: 0.05 },
  ...
  archer_ranger: {
    ...
    statMods: { spdPct: 0.1, atkPct: 0.05 },
    passive: { skillPowerPct: 0.1 },
    grants: ["arrow_volley"],
